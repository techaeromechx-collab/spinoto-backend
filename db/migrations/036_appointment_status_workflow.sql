-- ── Migration 036: Appointment Status Workflow ───────────────────────────────
-- 1. Add slug + is_system to appointment_statuses
-- 2. Seed 11 system statuses for the full workflow
-- 3. Add 'approved' to customer_invoices allowed statuses
...
--    On fresh DBs this table doesn't exist yet; the correct status list is in 065.
DO $$
BEGIN
